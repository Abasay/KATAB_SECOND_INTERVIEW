            ...
            <table className="min-w-full table-auto divide-y divide-gray-200">
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                <tr>
                  ...
                  <td className="whitespace-nowrap px-6 py-4">Payment</td>
                  <td className="whitespace-nowrap px-6 py-4">$20.00</td>
                  <td className="whitespace-nowrap px-6 py-4">-</td>
                  <td className="whitespace-nowrap px-6 py-4">$0.10</td>
                  <td className="whitespace-nowrap px-6 py-4">-</td>
                  <td className="whitespace-nowrap px-6 py-4">$1.50</td>
                  <td className="whitespace-nowrap px-6 py-4">$0.30</td>
                  <td className="whitespace-nowrap px-6 py-4">
                ...
                <tr>
                  ...
                  <td className="whitespace-nowrap px-6 py-4">Journey</td>
                  <td className="whitespace-nowrap px-6 py-4">-</td>
                  <td className="whitespace-nowrap px-6 py-4">50 miles</td>
                  <td className="whitespace-nowrap px-6 py-4">-</td>
                  <td className="whitespace-nowrap px-6 py-4">$0.25</td>
                  <td className="whitespace-nowrap px-6 py-4">$1.75</td>
                  <td className="whitespace-nowrap px-6 py-4">$0.35</td>
                  <td className="whitespace-nowrap px-6 py-4">
                    <button className="text-indigo-600 hover:text-indigo-900">
                      View Details
                    </button>
